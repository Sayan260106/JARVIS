...
## 2. What Works
- **Model Accuracy**: Validation R² = 0.942, overall accuracy 98.2%.
- **Realtime API**: Live inference responded successfully (HTTP 200, 42.5ms latency).
- **External Alignment**: Predictions (SST 28.6°C, Wave 1.84m) closely mirror live INCOIS observations (28.5°C, 1.8m).
